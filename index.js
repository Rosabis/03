...
document.addEventListener("keydown",function(e){
	switch(e.key)
	{
		...
		case "EndCall":
			...
			break;
	    case "0":
	    	document.getElementById('saveloader').click()//载入存档
	     	break;
	    case "1":
	     	navigator.volumeManager.requestUp();//提高音量
	     	break;
	    case "4":
	    	navigator.volumeManager.requestDown();//降低音量
	     	break;
	    case "7"://开启声音
	    ...
	    case "9":
	    	screenshot();//截图
	     	break;
	    case "*":
	     	document.getElementById('loader').click()//加载游戏
	     	break;
	    case "#":
	    	gba.downloadSavedata();//下载存档
	     	break;
	}
});
